...
export declare type TranslationButtonProps = React.HTMLAttributes<HTMLButtonElement> & {
    id?: string;
    text: string;
    isActive?: boolean;
    className?: string;
...
export declare type TranslationButtonGroupProps = React.HTMLAttributes<HTMLDivElement> & {
